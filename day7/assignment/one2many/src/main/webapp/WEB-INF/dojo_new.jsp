...
<%-- 
	...
	<div class="container p2 grid gap2">
		...
		<form:form class="card" action="/dojos/new" method="POST" modelAttribute="dojo" >
			<div class="card_head">
				<h1 class="col_white1">Add a new Dojo</h1>
			</div>
			
			<div class="card_body">
				<form:errors class="col_red" path="location" />
				<form:input placeholder="Dojo Location" path="location" />
